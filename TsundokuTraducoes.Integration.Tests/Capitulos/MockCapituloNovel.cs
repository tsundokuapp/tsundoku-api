...
{
    public class MockCapituloNovel
    {
        public static MultipartFormDataContent RetornaFormDataMockAdicionarCapituloNovel(bool falhar, Guid volumeId)
        {
        ...
        public static MultipartFormDataContent RetornaFormDataMockAdicionarCapituloNovelIlustracoes(bool falhar, Guid volumeId)
        {
            var form = new MultipartFormDataContent();
            var numero = $"{RetornaNumeroAleatorio()}";
            var titulo = $"O Destino de Alguns Aventureiros - Teste - {Guid.NewGuid().ToString().Substring(0, 8)}";
        ...
        public static MultipartFormDataContent RetornaFormDataMockAtualizarCapituloNovel(bool falhar, Guid volumeId, Guid capituloId)
        {
            var form = new MultipartFormDataContent();
            var numero = $"{RetornaNumeroAleatorio()}";
            var titulo = $"O Destino de Alguns Aventureiros - Teste - {Guid.NewGuid().ToString().Substring(0, 8)}";

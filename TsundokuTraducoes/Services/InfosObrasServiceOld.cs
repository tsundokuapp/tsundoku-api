...
{
    public class InfosObrasServiceOld : IInfosObrasServicesOld
    {
        private readonly IInfosObrasRepositoryOld _infosObrasRepository;
        public InfosObrasServiceOld(IInfosObrasRepositoryOld infosObrasRepository)
        {

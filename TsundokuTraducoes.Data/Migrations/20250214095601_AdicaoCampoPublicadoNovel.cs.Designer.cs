...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20250214095601_AdicaoCampoPublicadoNovel.cs")]
    partial class AdicaoCampoPublicadoNovelcs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(6421),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(6421),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5709),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5709),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(6056),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(6055),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("c501e19d-2f50-4e98-a8f1-54d9dd145474"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("8a371dfa-2ca0-48ae-bb97-82213ae463ef"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("bbbbd7c3-0e04-4540-b039-0aa94f3d5ac6"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("dda695de-b958-4009-84e8-987863d3046a"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("28330e22-bd1c-489b-ace7-7e55e9b9573b"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("773e1482-4765-41ce-9b0b-8441de1677a0"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("9b566314-f13c-42a6-a40c-ee11752424e3"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("f516c212-8bd7-4755-86f0-dfd45ade654f"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5430),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5511),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5429),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5156),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5396),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5148),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5627),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5626),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5540),
                            DataInclusao = new DateTime(2025, 2, 14, 6, 56, 0, 726, DateTimeKind.Local).AddTicks(5539),

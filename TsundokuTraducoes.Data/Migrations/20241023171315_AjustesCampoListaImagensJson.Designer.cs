...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20241023171315_AjustesCampoListaImagensJson")]
    partial class AjustesCampoListaImagensJson
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(5322),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(5321),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4940),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4939),
                            DiretorioImagemCapitulo = "G:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("abe509a6-6e57-4fc2-ab88-ba51e8bf284c"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("a15b147a-caf9-4920-a22c-03462e472338"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("b6567eae-444c-4eb8-bae4-d40f14c51dd2"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("76c5c6e0-c98f-4596-8c8c-ba170210fd87"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("d756a833-caf1-4ee9-b255-d0fa525fdd51"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("a7f87b2c-ed13-4d62-9d3f-e684236410e3"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("1e6426d3-e49e-4826-8817-edaac68eb6d0"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("0394625b-409d-4762-a072-0abb866709c3"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4351),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4424),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4351),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4132),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4321),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4128),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4533),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4533),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4450),
                            DataInclusao = new DateTime(2024, 10, 23, 14, 13, 14, 850, DateTimeKind.Local).AddTicks(4449),

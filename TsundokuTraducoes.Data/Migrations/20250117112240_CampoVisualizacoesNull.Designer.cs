...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20250117112240_CampoVisualizacoesNull")]
    partial class CampoVisualizacoesNull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(3083),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(3082),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2400),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2399),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2717),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2716),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("4e99898a-4bc3-4392-b3d6-6fb72bbf74c4"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("2b4742c0-52a1-4448-a49d-445a8c6728a9"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("959c4e1d-fed9-4596-a030-7852f89e7e99"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("238ae3a7-cbe4-40ae-81af-84f2abca12a4"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("293bb58a-9b68-43d6-b6a4-2684cd4466d9"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("a630987d-4330-48e6-8646-0a170bf4163f"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("2ba3656b-1229-4b28-945b-00cadbcaeca1"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("bfb1ac25-0950-487a-90d3-131dc5b15ed5"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2133),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2214),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2133),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(1920),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2082),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(1916),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2322),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2321),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2240),
                            DataInclusao = new DateTime(2025, 1, 17, 8, 22, 39, 420, DateTimeKind.Local).AddTicks(2240),

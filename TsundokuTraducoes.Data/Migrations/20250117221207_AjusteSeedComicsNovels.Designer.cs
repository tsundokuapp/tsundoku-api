...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20250117221207_AjusteSeedComicsNovels")]
    partial class AjusteSeedComicsNovels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(6827),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(6826),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5932),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5932),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(6421),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(6420),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("85b2479c-a75e-4be3-9c80-f3596bd6ffda"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("cc8a649c-18f9-4147-b67c-a94444b591a8"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("8194a6d9-c221-4156-95da-1fa437f254dc"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("262f3806-0ed9-4fd7-8cd5-c69a931ba8b8"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("eee15f56-25ff-4cb3-974b-7d050afe6cef"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("8fa6790f-0a7b-4ee1-91d6-5bfc4aaa1836"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("54bedec0-9122-4ed7-9325-6fc35ba7ae65"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("87c236a7-d87d-42c2-8d0b-ee64fc5428d1"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5592),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5694),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5592),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5179),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5519),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5163),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5837),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5837),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5727),
                            DataInclusao = new DateTime(2025, 1, 17, 19, 12, 7, 306, DateTimeKind.Local).AddTicks(5727),

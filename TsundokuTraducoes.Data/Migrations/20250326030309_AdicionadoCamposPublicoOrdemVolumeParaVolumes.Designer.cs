            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 967, DateTimeKind.Local).AddTicks(83),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 967, DateTimeKind.Local).AddTicks(82),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9352),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9352),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9668),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9667),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("063216e7-fdc5-45f6-b497-f325ecff98e0"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("4f19e568-b1a5-460e-b560-e5839dabc128"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("650236f4-34da-4dc4-8303-6fb55867004a"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("2b273d16-ebbe-4bbc-b6df-0d69fbab68c3"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("bb28228b-caae-4ef0-a5a5-aab244fa426a"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("74b81ceb-6207-4d9f-a878-859e954bc09e"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("3d208749-03ef-4dd5-81a9-fde7e1c16db1"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("2315bb4f-929c-47d4-9712-873a168fbb55"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9019),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9152),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9019),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(8817),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(8990),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(8813),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9270),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9270),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9180),
                            DataInclusao = new DateTime(2025, 3, 26, 0, 3, 7, 966, DateTimeKind.Local).AddTicks(9180),

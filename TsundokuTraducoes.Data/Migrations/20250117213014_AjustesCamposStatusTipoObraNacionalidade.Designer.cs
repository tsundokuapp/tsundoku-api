...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20250117213014_AjustesCamposStatusTipoObraNacionalidade")]
    partial class AjustesCamposStatusTipoObraNacionalidade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(4095),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(4095),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3417),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3417),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3723),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3722),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("8ec24110-2134-4b6b-8dbc-ff8963c4380b"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("d90c302c-5301-4486-9ddc-6d7097624649"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("2abd2506-1b43-4e64-b9cc-e379dcc03fc1"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("2145e079-a2ce-4543-a9bc-1b2b6a94ea16"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("ee6a6f9d-d94a-4ffc-86bc-0e773e8d7843"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("d430cdfc-19fc-4329-9eae-f29bc4b01832"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("996a22d6-6e34-4f1e-b2b2-ff97b143e140"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("611e1ec5-1d76-4037-90ba-933c1dc7a648"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3139),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3221),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3139),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(2945),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3111),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(2941),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3333),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3332),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3248),
                            DataInclusao = new DateTime(2025, 1, 17, 18, 30, 13, 818, DateTimeKind.Local).AddTicks(3248),

...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20250129052922_AdicionadoCampoIntegracaoDiscord")]
    partial class AdicionadoCampoIntegracaoDiscord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1967),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1966),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConteudoNovel = "",
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1222),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1221),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1560),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1559),
                            DiretorioImagemCapitulo = "H:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("19e84c83-54bc-467e-ac71-5f55238515b3"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("cd9e6827-01c7-4f83-ac09-c3e5c29c603d"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("986f0c26-761a-4c11-8f4b-5bb87497a037"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("0fa9fda7-d81f-41a5-a722-b757707e8384"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("aa3a56e1-7132-4371-9a03-a08e8864f90f"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("6f285d1e-2826-4d2f-8cfc-532ace1caee0"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("d3114b1e-0f99-4f1f-8b82-df6a0c091ea1"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("9ad141fe-9ba9-4783-98dc-2a0cec255e33"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(931),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1015),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(930),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(720),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(898),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(716),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1133),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1132),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1044),
                            DataInclusao = new DateTime(2025, 1, 29, 2, 29, 21, 547, DateTimeKind.Local).AddTicks(1044),

...
namespace TsundokuTraducoes.Data.Migrations
{
    ...
    [Migration("20240411000304_AdicaoCamposExtrasGeneros")]
    partial class AdicaoCamposExtrasGeneros
    {
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(420),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(420),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Capitulo.CapituloNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(245),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(244),
                        ...
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(329),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(329),
                            DiretorioImagemCapitulo = "G:\\Tsundoku\\BackEnd\\tsundoku-api\\TsundokuTraducoes\\wwwroot\\assets\\images\\BruxaErrante\\Volume01\\Ilustracoes",
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Generos.Genero", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("2e55ab74-9f1b-4f95-93f6-322dee0326b3"),
                            Descricao = "Ação",
                            Slug = "acao"
                        },
                        new
                        {
                            Id = new Guid("b9afdacf-5616-4411-8a2f-3dc683d2f064"),
                            Descricao = "Comédia",
                            Slug = "comedia"
                        },
                        new
                        {
                            Id = new Guid("fb60727b-6843-4a2f-96e8-a38c80653a32"),
                            Descricao = "Drama",
                            Slug = "drama"
                        },
                        new
                        {
                            Id = new Guid("474f9278-5731-404b-914a-10dd85a0b49a"),
                            Descricao = "Slice of Life",
                            Slug = "slice-of-life"
                        },
                        new
                        {
                            Id = new Guid("49ec8349-6ed2-43ad-8618-5a60c21f5234"),
                            Descricao = "Isekai",
                            Slug = "isekai"
                        },
                        new
                        {
                            Id = new Guid("4562843a-45ed-45e1-995e-28cbc0db8580"),
                            Descricao = "Harém",
                            Slug = "harem"
                        },
                        new
                        {
                            Id = new Guid("276d8207-e682-4b48-b74c-7f141ede6faa"),
                            Descricao = "Horror",
                            Slug = "horror"
                        },
                        new
                        {
                            Id = new Guid("51a67cc5-1ff8-44c1-97a2-282cb547c522"),
                            Descricao = "Fantasia",
                            Slug = "fantasia"
                        });
                });
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Comic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(79),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 845, DateTimeKind.Local).AddTicks(9999),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Obra.Novel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 845, DateTimeKind.Local).AddTicks(9815),
                            DataAtualizacaoUltimoCapitulo = new DateTime(2024, 4, 10, 21, 3, 3, 845, DateTimeKind.Local).AddTicks(9979),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 845, DateTimeKind.Local).AddTicks(9811),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeComic", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ComicId = new Guid("3d6a759d-8c9e-4891-9f0e-89b8d99821cb"),
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(170),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(170),
            ...
            modelBuilder.Entity("TsundokuTraducoes.Entities.Entities.Volume.VolumeNovel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DataAlteracao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(94),
                            DataInclusao = new DateTime(2024, 4, 10, 21, 3, 3, 846, DateTimeKind.Local).AddTicks(94),
